...
A python client for [MetricWire's Catalyst system](https://metricwire.com) API.

API documentation is available at: [https://app.swaggerhub.com/apis-docs/MetricWire/ConsumerAPI/3.0.0#/](https://app.swaggerhub.com/apis-docs/MetricWire/ConsumerAPI/3.0.0#/)
